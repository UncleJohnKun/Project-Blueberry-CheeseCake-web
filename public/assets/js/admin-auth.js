// Admin Authentication for Login Page
document.addEventListener('DOMContentLoaded', () => {
    ...
    adminLoginForm.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            // Redirect to appropriate portal - UPDATE PATHS FOR NEW STRUCTURE
            setTimeout(() => {
                if (result.isAdmin) {
                    window.location.href = 'pages/dashboard.html';  // Updated path
                } else {
                    window.location.href = 'pages/teacher-portal.html';  // Updated path
                }
            }, 1000);
